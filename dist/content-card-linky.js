...
`;function ve(e,t=1){const a=Number.parseFloat(e);return isNaN(a)?"–":a.toFixed(t)}function ye(e){return e?.locale?.language||"en"}function fe(e){return e.showIcon?O` <div class="icon-block">
      <span
      ...
      ></span>
    </div>`:O``}function ge(e,t,a){return t.showPrice?O` <div class="cout-block">
      <span class="cout" title="${pe(e,"card.daily_cost")}">${ve(a.daily_cost,2)}</span
      ><span class="cout-unit"> €</span>
    </div>`:O``}function we(e){const t=Number(e);return isNaN(t)?0:Math.round(t)}function _e(e){const t=e.getDay();return 0===t?6:t-1}function be(e,t,a=new Date){if(!e)return 0;const o=_e(a);let i=0;for(let a=Math.min(o,e.length-1);a>=1;a--){const o=parseFloat(String(e[a]));if(!isNaN(o)&&-1!==o&&0!==o){i+=o;continue}if(!t)continue;const n=t.toString().split(","),r=parseFloat(n[a]?.replace(",","."));if(isNaN(r)||r<=0)continue;const s=[];for(let t=0;t<Math.min(e.length,n.length,7);t++){if(t===a)continue;const o=parseFloat(String(e[t])),i=parseFloat(n[t]?.replace(",","."));!isNaN(o)&&!isNaN(i)&&o>0&&i>0&&-1!==o&&-1!==i&&s.push(o/i)}if(0===s.length)continue;const l=s.reduce((e,t)=>e+t,0)/s.length,c=r*l;c>0&&(i+=c)}return i}function $e(e,t=new Date){if(!e)return 0;const a=_e(t),o=e.toString().split(",");let i=0;for(let e=Math.min(a,o.length-1);e>=1;e--){const t=parseFloat(o[e].replace(",","."));isNaN(t)||-1===t||(i+=t)}return i}function ke(e,t){const a=[],o=e?.attributes?.forecast;if(!o)return a;for(const[e,i]of Object.entries(o)){if(void 0===e)continue;const o=e.replace("h","").replace("min","").trim();a.push([o,t.get(i),i])}return a}function xe(e){const t=new Date;return t.setFullYear(t.getFullYear()-1),t.toLocaleDateString(ye(e),{year:"numeric"})}function Ee(e){const t=new Date;return t.setMonth(t.getMonth()-1),t.setFullYear(t.getFullYear()-1),t.toLocaleDateString(ye(e),{month:"long",year:"numeric"})}function Ae(e){const t=new Date;return t.setFullYear(t.getFullYear()-1),t.toLocaleDateString(ye(e),{month:"long",year:"numeric"})}function De(e,t,a,o){const i=we(t);return O` <span class="variations-linky">
  ...
  </span>`}function Se(e,t){if(null!=e)return e.toString().split(",")[t-1]}function Pe(e,t,a,o=new Date){if(!t.showWeekSummary&&void 0!==t.showWeekSummary)return O``;const{daily:i,unit_of_measurement:n,dailyweek_cost:r}=a,s=be(i,r,o),l=$e(r,o),c=new Date(o);c.setDate(o.getDate()-(0===o.getDay()?6:o.getDay()-1));const p=function(e=new Date){const t=e.getMonth();return t>=2&&t<=4?{primary:"#66bb6a",accent:"#81c784",icon:"mdi:flower"}:t>=5&&t<=7?{primary:"#42a5f5",accent:"#29b6f6",icon:"mdi:white-balance-sunny"}:t>=8&&t<=10?{primary:"#ff7043",accent:"#ffab40",icon:"mdi:leaf"}:{primary:"#5c6bc0",accent:"#7986cb",icon:"mdi:snowflake"}}(o);return O`
    <div class="week-summary-card">
      ...
      <div class="week-summary-content">
        <div class="week-summary-main">
          <span class="week-summary-value">${ve(s,1)}</span>
  ...
  `}function Me(e){return O`
    ...
    ></span>
  `}function Te(e,t,a,o,i,n=new Date){if(a&&"undefined"!==a.toString()){const e=Se(a,o);if(e&&"-1"!==e)return e.toLowerCase()}const r=function(e,t){const a=["sensor.rte_tempo_today","sensor.edf_tempo_today","sensor.tempo_today","sensor.rte_tempo_tomorrow","sensor.edf_tempo_tomorrow","sensor.tempo_tomorrow"],o={};for(const t of a)if(e.states[t]){const a=e.states[t];a.state&&ue.has(a.state)&&(t.includes("today")?o.today=t:t.includes("tomorrow")&&(o.tomorrow=t))}if(t.tempoEntity&&e.states[t.tempoEntity]){const a=e.states[t.tempoEntity];a.state&&ue.has(a.state)&&(o.today=t.tempoEntity)}return o}(e,t);if(i&&Object.keys(r).length>0){const t=new Date(i),a=new Date(n),o=new Date(n);if(o.setDate(a.getDate()+1),t.toDateString()===a.toDateString()&&r.today){const t=e.states[r.today];if(t&&t.state&&ue.has(t.state))return ue.get(t.state)}if(t.toDateString()===o.toDateString()&&r.tomorrow){const t=e.states[r.tomorrow];if(t&&t.state&&ue.has(t.state))return ue.get(t.state)}}return"grey"}function He(e,t,a,o,i,n){if(-1===a||0===a||"0"===a||null==a){if(!n)return Me(e);{const a=Se(n,o);if(a&&"-1"!==a&&parseFloat(String(a??"").replace(",","."))>0){const a=function(e,t,a){if(!e||!a)return 0;const o=a.toString().split(","),i=parseFloat(o[t-1]?.replace(",","."));if(isNaN(i)||i<=0)return 0;const n=[];for(let t=0;t<Math.min(e.length,o.length,7);t++){const a=parseFloat(String(e[t])),i=parseFloat(o[t]?.replace(",","."));!isNaN(a)&&!isNaN(i)&&a>0&&i>0&&-1!==a&&-1!==i&&n.push(a/i)}return 0===n.length?0:i*(n.reduce((e,t)=>e+t,0)/n.length)}(e.states[t.entity].attributes.daily,o,n);if(a>0)return O`
            <br /><span class="cons-val estimated" title="${pe(e,"card.history.estimated")}"
              >${ve(a)} ${t.showInTableUnit?O` ${i}`:O``}</span
            >
          `}else if(!a||"-1"===a)return Me(e)}return Ce(e)}return O`
    <br /><span class="cons-val"
      >${ve(a)} ${t.showInTableUnit?O` ${i}`:O``}</span
    >
  `}function Ne(e,t,a,o){if(t.showDayPriceHCHP){const t=Se(a,o);return"-1"===t?Ce(e):O` <br /><span class="cons-val">${ve(t,2)} €</span> `}}function We(e,t,a,o,i){if(t.showDayHCHP){const n=Se(a,o);return"-1"===n?Ce(e):O`
      <br /><span class="cons-val"
        >${ve(n,2)} ${t.showInTableUnit?O` ${i}`:O``}</span
      >
    `}}function ze(e,t,a){return!0===e?O`<span class="titre-desktop">${t}</span><span class="titre-mobile">${a}</span><br /> `:O``}function Fe(e,t,a,o,i,n){const{unit_of_measurement:r}=i;return O`
    <div class="day">
      ${function(e,t,a,o,i,n){const r=Se(a,i);let s="grey";return t.showTempoColor&&(s=Te(e,t,o,i,r,n)),O`
    <span class="tempo-day-wrapper">
      <span
        class="tempoday-${s}"
        style="display: inline-block;"
        title="${pe(e,"card.history.tempo_day",{color:s,date:r})}"
        >${new Date(r??"").toLocaleDateString(ye(e),{weekday:t.showDayName})}</span
      >
    </span>
  `}(e,t,i.dailyweek,i.dailyweek_Tempo,o,n)}
      ${He(e,t,a,o,r,i.dailyweek_cost)}
      ${function(e,t,a,o,i){if(t.showDayPrice){const t=Se(a,o);return"-1"===t?Ce(e):O` <br /><span class="cons-val">${ve(t,2)} €</span> `}if(t.kWhPrice){const a=parseFloat(i);return isNaN(a)||a<=0?Ce(e):O` <br /><span class="cons-val">${ve(a*t.kWhPrice,2)} €</span> `}}(e,t,i.dailyweek_cost,o,a)}
      ${Ne(e,t,i.dailyweek_costHC,o)}
      ${Ne(e,t,i.dailyweek_costHP,o)}
      ${We(e,t,i.dailyweek_HC,o,r)}
      ${We(e,t,i.dailyweek_HP,o,r)}
      ${function(e,t,a,o,i,n){if(t.showDayMaxPower){const r=Se(a,o),s=Se(i,o);if("-1"===r)return Ce(e);const l="true"===s?"color: var(--error-color, red)":"",c=!1!==t.showDayMaxPowerTime?O`<br /><span class="cons-val" style="${l}"
              >${new Date(Se(n,o)??"").toLocaleTimeString(ye(e),{hour:"2-digit",minute:"2-digit"})}</span
            >`:O``;return O`<br /><span class="cons-val" style="${l}">${ve(r,2)}</span>${c}`}}(e,t,i.dailyweek_MP,o,i.dailyweek_MP_over,i.dailyweek_MP_time)}
    </div>
  `}function Re(e,t,a,o=new Date){if(!0!==t.showHistory)return;const{daily:i,dailyweek:n}=a;if(void 0===n)return;if(!Array.isArray(i))return;let r=n.toString().split(",").length;return Number(t.nbJoursAffichage)<=r&&(r=Number(t.nbJoursAffichage)),O`
    ${Pe(e,t,a,o)}
    <div class="week-history">
      ${function(e,t){if(!0===t.showTitleLign){const a=t=>pe(e,`card.history.${t}`);return O`
      <div class="day">
        ${ze(!0,"","")} ${ze(!0,a("col_consumption"),a("col_consumption"))}
        ${ze(t.showDayPrice,a("col_price"),a("col_price"))}
        ${ze(t.showDayPriceHCHP,a("col_price_offpeak"),a("col_price_offpeak_mobile"))}
        ${ze(t.showDayPriceHCHP,a("col_price_peak"),a("col_price_peak_mobile"))}
        ${ze(t.showDayHCHP,a("col_offpeak"),a("col_offpeak"))}
        ${ze(t.showDayHCHP,a("col_peak"),a("col_peak"))}
        ${ze(t.showDayMaxPower,a("col_max_power"),a("col_max_power"))}
        ${ze(!0===t.showDayMaxPower&&!1!==t.showDayMaxPowerTime,a("col_max_power_time"),a("col_max_power_time"))}
      </div>
    `}}(e,t)}
      ${i.slice(-r).map((n,s)=>{const l=i.length-r+s+1;return Fe(e,t,n,l,a,o)}).reverse()}
    </div>
  `}function Le(e){return t=>{"Enter"!==t.key&&" "!==t.key||(t.preventDefault?.(),e(t))}}const Ue=new Map([["Pas de valeur","green"],[1,"green"],[2,"yellow"],[3,"red"]]);function Oe(e,t){return O`
  ...
  `}function Ye(e){const t=new Date(e.attributes.date??""),a=e.state;return[t,ue.get(a),a]}function Je(e,t,a){if(!e||e.length<=1||0===t)return O`<svg viewBox="0 0 100 50" class="consumption-chart"></svg>`;const o=e.map((a,o)=>`${o/(e.length-1)*100},${100-a.consumption/t*100}`).join(" ");return O`
  ...
  `}function je(e,t,a,o,i){if(!t.showDetailedComparison)return O``;if(!t.detailedComparisonEntity)return O``;const n=e.states[t.detailedComparisonEntity];if(!n)return O`
    ...
    `;const r=n.attributes;let s;if(Array.isArray(r.time)&&Array.isArray(r.consumption))s=function(e,t,a=new Date){const o=new Date(a.getFullYear(),a.getMonth(),a.getDate()),i=new Date(o.getTime()-864e5),n=[],r=[];if(!Array.isArray(e)||!Array.isArray(t))return{today:n,yesterday:r,todayTotal:0,yesterdayTotal:0,evolution:0};for(let a=0;a<e.length;a++){const s=e[a];if(null==s)continue;const l="string"==typeof s?s.replace(" ","T"):s,c=new Date(l);if(isNaN(c.getTime()))continue;const p=parseFloat(t[a]);if(isNaN(p))continue;const d=new Date(c.getFullYear(),c.getMonth(),c.getDate());d.getTime()===o.getTime()?n.push({time:c,consumption:p}):d.getTime()===i.getTime()&&r.push({time:c,consumption:p})}const s=n.reduce((e,t)=>e+t.consumption,0)/1e3,l=r.reduce((e,t)=>e+t.consumption,0)/1e3;return{today:n,yesterday:r,todayTotal:s,yesterdayTotal:l,evolution:s>0&&0!==l?(s-l)/l*100:0}}(r.time,r.consumption);else{if(!r.Daily||!r.Dailyweek){const t=Object.keys(r).join(", ");return O`
      <div class="collapsible-section">
        <div class="collapsible-header">
          <span class="section-title">${pe(e,"card.comparison.title")}</span>
          <span class="section-summary"
    ...
    `}s=function({Daily:e,Dailyweek:t},a=new Date){const o=e.split(",").map(e=>parseFloat(e.trim().replace(",","."))),i=t.split(",").map(e=>{const[t,o]=e.trim().split("/");return new Date(a.getFullYear(),parseInt(o,10)-1,parseInt(t,10))}),n=new Date(a.getFullYear(),a.getMonth(),a.getDate()),r=new Date(n.getTime()-864e5),s=[],l=[];i.forEach((e,t)=>{const a=o[t]||0,i=new Date(e.getFullYear(),e.getMonth(),e.getDate());i.getTime()===n.getTime()?s.push({time:e,consumption:a}):i.getTime()===r.getTime()&&l.push({time:e,consumption:a})});const c=s.reduce((e,t)=>e+t.consumption,0)/1e3,p=l.reduce((e,t)=>e+t.consumption,0)/1e3;return{today:s,yesterday:l,todayTotal:c,yesterdayTotal:p,evolution:c>0&&0!==p?(c-p)/p*100:0}}({Daily:r.Daily,Dailyweek:r.Dailyweek})}return O`
    <div class="collapsible-section">
      <div
    ...
    <div class="comparison-charts">
      <div class="chart-day">
        ...
        <div class="mini-chart">${Je(t.today,o,"#2196f3")}</div>
        <div class="day-stats">
      ...
      <div class="chart-day">
        ...
        <div class="mini-chart">${Je(t.yesterday,o,"#666")}</div>
        <div class="day-stats">
  ...
  `}const Ie="1.9.0";function Ve(e){if(!e||!e.entity)throw new Error("You need to define an entity");if(void 0!==e.kWhPrice&&null!==e.kWhPrice&&isNaN(Number(e.kWhPrice)))throw new Error("kWhPrice should be a number")}window.customCards=window.customCards||[],window.customCards.push({type:"content-card-linky",name:"Carte Enedis",description:"Carte pour l'intégration MyElectricalData - Affichage moderne des données Linky avec évolutions colorées",preview:!0,documentationURL:"https://github.com/foXaCe/content-card-linky",version:Ie,getEntitySuggestion:(e,t)=>{const a=e.states[t];if(!a)return null;const o=a.attributes||{};return/linky/i.test(t)||"consommation"===o.typeCompteur||void 0!==o.daily&&void 0!==o.dailyweek?{config:{type:"custom:content-card-linky",entity:t}}:null}}),console.info(`%c content-card-linky %c v${Ie} `,"color: white; background: #4caf50; font-weight: 700;","color: white; background: #1976d2; font-weight: 700;");class qe extends ne{static get properties(){return{config:{attribute:!1},hass:{attribute:!1},_monthlyExpanded:{state:!0},_yearlyExpanded:{state:!0},_detailedExpanded:{state:!0}}}constructor(){super(),this._monthlyExpanded=!1,this._yearlyExpanded=!1,this._detailedExpanded=!1}static async getConfigElement(){return await(import("./content-card-linky-editor.js")),document.createElement("content-card-linky-editor")}static async getStubConfig(e){let t="sensor.linky_consumption";if(e&&e.states){const a=Object.keys(e.states).find(t=>{if(!t.startsWith("sensor."))return!1;const a=e.states[t].attributes||{};return/linky/i.test(t)||"consommation"===a.typeCompteur||void 0!==a.daily&&void 0!==a.dailyweek});a&&(t=a)}return{type:"custom:content-card-linky",entity:t,titleName:"LINKY",nbJoursAffichage:"7",showIcon:!0,showHistory:!0,showPrice:!0,showDayPrice:!0,showCurrentMonthRatio:!0,showWeekRatio:!0,showDayName:"long",showDayMaxPower:!0,showTitleLign:!0,showEcoWatt:!0,showTempo:!1,showMonthlyView:!0,showYearlyView:!0,showDetailedComparison:!0,detailedComparisonEntity:"sensor.linky_consumption_last5day"}}render(){if(!this.config||!this.hass)return O``;const e=this.config,t=this.hass;this.dataset.appearance=e.appearance??"premium";const a=t.states[e.entity];if(!a)return O`
      ...
      `;const o=a.attributes,i=o.typeCompteur;return"consommation"!==i&&"production"!==i&&i?O``:O` <ha-card id="card" @click="${()=>this._showDetails(e.entity)}">
    ...
    ${t.showYearRatio?De(e,a.yearly_evolution,"card.aria.yearly_trend",O`
              <span class="year">${pe(e,"card.previous_year",{year:xe(e)})}</span>
              <span class="tooltiptext"
                >${pe(e,"card.tooltip.year_prev",{value:a.current_year_last_year})}<br />${pe(e,"card.tooltip.year",{value:a.current_year})}</span
              >
            `):O``}
    ${t.showMonthRatio?De(e,a.monthly_evolution,"card.aria.monthly_trend",O`
              <span class="previous-month"
                >${pe(e,"card.previous_month",{month:Ee(e)})}</span
              >
              <span class="tooltiptext"
              ...
              >
            `):O``}
    ${t.showCurrentMonthRatio?De(e,a.current_month_evolution,"card.aria.current_month_trend",O`
              <span class="current-month">${pe(e,"card.current_month",{month:Ae(e)})}</span>
              <span class="tooltiptext"
                >${pe(e,"card.tooltip.month_prev_year",{value:a.current_month_last_year})}<br />${pe(e,"card.tooltip.month",{value:a.current_month})}</span
              >
            `):O``}
    ${t.showWeekRatio?De(e,a.current_week_evolution,"card.aria.weekly_trend",O`
              <span class="previous-month"
              ...
              >
            `):O``}
    ${t.showYesterdayRatio?De(e,a.yesterday_evolution,"card.aria.daily_trend",O`
              <span class="previous-month"
    ...
    ${t.showPeakOffPeak?O` <span class="variations-linky">
            ...
            ${we(a.peak_offpeak_percent)}<span class="unit"> ${pe(e,"card.peak_pct")}</span>
          </span>`:O``}
  </div>`}(t,e,o)}
          ${!1!==e.showSmartInsights?function(e,t,a,o=new Date){const i=be(a.daily,a.dailyweek_cost,o),n=$e(a.dailyweek_cost,o),r=parseFloat((a.current_month||0).toString().replace(",",".")),s=r>0?r/o.getDate()*new Date(o.getFullYear(),o.getMonth()+1,0).getDate():i>0?i/7*30:0,l=n>0?n/7*30:0,c=parseFloat((a.current_week_evolution||0).toString().replace(",",".")),p=parseFloat((a.monthly_evolution||0).toString().replace(",",".")),d=parseFloat((a.yearly_evolution||0).toString().replace(",",".")),u=c<0,h=p<0,m=d<0,v=u?"mdi:trending-down":"mdi:trending-up",y=u?"trend-good":"trend-bad",f=h?"mdi:trending-down":"mdi:trending-up",g=h?"trend-good":"trend-bad",w=m?"mdi:trending-down":"mdi:trending-up",_=m?"trend-good":"trend-bad";return O`
      ...
      <div class="insight-row">
        <div class="insight-item">
          ...
          <div class="insight-content">
            ...
            <div class="insight-value">${s.toFixed(0)} kWh • ${l.toFixed(0)}€</div>
          </div>
        </div>
  ...
  `}(t,0,o):O``}
          ${Re(t,e,o)}
          ${function(e,t,a,o,i){if(!t.showMonthlyView)return O``;const n=a.current_month||"N/A",r=a.last_month||"N/A",s=a.current_month_last_year||"N/A",l=a.last_month_last_year||"N/A",c=[{name:pe(e,"card.temporal.current_month"),value:n,year:(new Date).getFullYear(),evolution:"N/A"!==s&&"N/A"!==n?((parseFloat(String(n))-parseFloat(String(s)))/parseFloat(String(s))*100).toFixed(1):null},{name:pe(e,"card.temporal.previous_month"),value:r,year:(new Date).getFullYear(),evolution:"N/A"!==l&&"N/A"!==r?((parseFloat(String(r))-parseFloat(String(l)))/parseFloat(String(l))*100).toFixed(1):null},{name:pe(e,"card.temporal.current_month_prev_year"),value:s,year:(new Date).getFullYear()-1,evolution:null},{name:pe(e,"card.temporal.previous_month_prev_year"),value:l,year:(new Date).getFullYear()-1,evolution:null}].filter(e=>"N/A"!==e.value);return O`
    <div class="collapsible-section">
      <div
        class="collapsible-header"
        role="button"
  ...
  `}(t,e,o,this._monthlyExpanded,e=>this.toggleMonthlyView(e))}
          ${function(e,t,a,o,i){if(!t.showYearlyView)return O``;const n=a.current_year||"N/A",r=a.current_year_last_year||"N/A",s=[{name:(new Date).getFullYear(),value:n,evolution:"N/A"!==r&&"N/A"!==n?((parseFloat(String(n))-parseFloat(String(r)))/parseFloat(String(r))*100).toFixed(1):null},{name:(new Date).getFullYear()-1,value:r,evolution:null}].filter(e=>"N/A"!==e.value);return O`
    <div class="collapsible-section">
      <div
        class="collapsible-header"
        role="button"
      ...
      >
        ...
        <span class="section-summary">
          ${s.length>0?pe(e,"card.temporal.years_count",{count:s.length}):pe(e,"card.temporal.no_data")}
        </span>
      </div>
      <div class="collapsible-content ${o?"expanded":"collapsed"}">
  ...
  `}(t,e,o)}
          ${function(e,t){if(!0===e.showError&&t)return O`
    ...
    `:O``}(t,o.versionUpdateAvailable??!1,o.versionGit??"")}
