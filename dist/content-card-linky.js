...
`;function ye(e,t=1){const o=Number.parseFloat(e);return isNaN(o)?"–":o.toFixed(t)}function ge(e){return e?.locale?.language||"fr-FR"}function fe(e){const t=Number(e);return isNaN(t)?0:Math.round(t)}function ve(e){const t=e.getDay();return 0===t?6:t-1}function we(e,t,o){if(!e||!o)return 0;const i=o.toString().split(","),a=parseFloat(i[t-1]?.replace(",","."));if(isNaN(a)||a<=0)return 0;const n=[];for(let t=0;t<Math.min(e.length,i.length,7);t++){const o=parseFloat(e[t]),a=parseFloat(i[t]?.replace(",","."));!isNaN(o)&&!isNaN(a)&&o>0&&a>0&&-1!==o&&-1!==a&&n.push(o/a)}if(0===n.length)return 0;return a*(n.reduce((e,t)=>e+t,0)/n.length)}function be(e,t){const o=[],i=e?.attributes?.forecast;if(!i)return o;for(const[e,a]of Object.entries(i)){if(void 0===e)continue;const i=e.replace("h","").replace("min","").trim();o.push([i,t.get(a),a])}return o}function $e(e){return e.showIcon?O` <div class="icon-block">
      <span
      ...
      ></span>
    </div>`:O``}function _e(e,t,o){return t.showPrice?O` <div class="cout-block">
      <span class="cout" title="${de(e,"card.daily_cost")}">${ye(o.daily_cost,2)}</span
      ><span class="cout-unit"> €</span>
    </div>`:O``}function xe(e,t,o){return O` <div class="variations">
    ${t.showYearRatio?O` <span class="variations-linky">
          <div class="percentage-line">
            ...
            <span
              ...
              aria-label="Évolution annuelle: ${fe(o.yearly_evolution)}%"
              role="text"
              >${fe(o.yearly_evolution)}<span class="unit"> %</span></span
            >
          </div>
          <div class="tooltip">
            <span class="year">vs ${function(e){const t=new Date;return t.setFullYear(t.getFullYear()-1),t.toLocaleDateString(ge(e),{year:"numeric"})}(e)}</span>
            <span class="tooltiptext"
              >A-1 : ${o.current_year_last_year}<br />A : ${o.current_year}</span
            >
          </div>
        </span>`:O``}
    ${t.showMonthRatio?O` <span class="variations-linky">
          <div class="percentage-line">
            ...
            <span
              ...
              aria-label="Évolution mensuelle: ${fe(o.monthly_evolution)}%"
              role="text"
              >${fe(o.monthly_evolution)}<span class="unit"> %</span></span
            >
          </div>
          <div class="tooltip">
            <span class="previous-month">vs ${function(e){const t=new Date;return t.setMonth(t.getMonth()-1),t.setFullYear(t.getFullYear()-1),t.toLocaleDateString(ge(e),{month:"long",year:"numeric"})}(e)}</span>
            <span class="tooltiptext"
              >Mois Precedent A-1 : ${o.last_month_last_year}<br />Mois Precedent :
              ${o.last_month}</span
            >
          </div>
        </span>`:O``}
    ${t.showCurrentMonthRatio?O` <span class="variations-linky">
          <div class="percentage-line">
            ...
            <span
              ...
              aria-label="Évolution du mois courant: ${fe(o.current_month_evolution)}%"
              role="text"
              >${fe(o.current_month_evolution)}<span class="unit"> %</span></span
            >
          </div>
          <div class="tooltip">
            <span class="current-month">vs ${function(e){const t=new Date;return t.setFullYear(t.getFullYear()-1),t.toLocaleDateString(ge(e),{month:"long",year:"numeric"})}(e)}</span>
            <span class="tooltiptext"
              >Mois A-1 : ${o.current_month_last_year}<br />Mois : ${o.current_month}</span
            >
          </div>
        </span>`:O``}
    ${t.showWeekRatio?O` <span class="variations-linky">
          <div class="percentage-line">
            ...
            <span
              ...
              aria-label="Évolution hebdomadaire: ${fe(o.current_week_evolution)}%"
              role="text"
          ...
          <div class="tooltip">
            ...
            <span class="tooltiptext"
              >Semaine dernière : ${o.last_week}<br />Semaine courante : ${o.current_week}</span
            >
          </div>
        </span>`:O``}
    ${t.showYesterdayRatio?O` <span class="variations-linky">
          <div class="percentage-line">
            ...
            <span
              ...
              aria-label="Évolution quotidienne: ${fe(o.yesterday_evolution)}%"
              role="text"
          ...
          <div class="tooltip">
            ...
            <span class="tooltiptext">Avant-hier : ${o.day_2}<br />Hier : ${o.yesterday}</span>
          </div>
        </span>`:O``}
    ...
    <div class="week-summary-card" style="background: ${d}">
      <div class="week-summary-header">
        ...
        <span class="week-summary-period"
          >${de(e,"card.since")}
          ${c.toLocaleDateString(ge(e),{day:"numeric",month:"short"})}</span
        >
      </div>
  ...
  `}function Ae(){return O`
    ...
    ></span>
  `}function De(e,t,o,i,a){if(o&&"undefined"!==o.toString()){const e=o.toString().split(",")[i-1];if(e&&"-1"!==e)return e.toLowerCase()}const n=function(e,t){const o=["sensor.rte_tempo_today","sensor.edf_tempo_today","sensor.tempo_today","sensor.rte_tempo_tomorrow","sensor.edf_tempo_tomorrow","sensor.tempo_tomorrow"],i={};for(const t of o)if(e.states[t]){const o=e.states[t];o.state&&he.has(o.state)&&(t.includes("today")?i.today=t:t.includes("tomorrow")&&(i.tomorrow=t))}if(t.tempoEntity&&e.states[t.tempoEntity]){const o=e.states[t.tempoEntity];o.state&&he.has(o.state)&&(i.today=t.tempoEntity)}return i}(e,t);if(a&&Object.keys(n).length>0){const t=new Date(a),o=new Date,i=new Date;if(i.setDate(o.getDate()+1),t.toDateString()===o.toDateString()&&n.today){const t=e.states[n.today];if(t&&t.state&&he.has(t.state))return he.get(t.state)}if(t.toDateString()===i.toDateString()&&n.tomorrow){const t=e.states[n.tomorrow];if(t&&t.state&&he.has(t.state))return he.get(t.state)}}return"grey"}function Se(e,t,o){if(e.showDayPriceHCHP){const e=t.toString().split(",")[o-1];return"-1"===e?Ee():O` <br /><span class="cons-val">${ye(e,2)} €</span> `}}function Pe(e,t,o,i){if(e.showDayHCHP){const a=t.toString().split(",")[o-1];return"-1"===a?Ee():O`
      <br /><span class="cons-val"
        >${ye(a,2)} ${e.showInTableUnit?O` ${i}`:O``}</span
      >
    `}}function Ce(e,t){if(!0===e){return O`<span class="titre-desktop">${t}</span><span class="titre-mobile">${{"Prix HC":"€ HC","Prix HP":"€ HP"}[t]||t}</span><br /> `}return O``}function He(e,t,o,i,a){const{unit_of_measurement:n}=a;return O`
    <div class="day">
      ${function(e,t,o,i,a){const n=o.toString().split(",")[a-1];let s="grey";return t.showTempoColor&&(s=De(e,t,i,a,n)),O`
    <span class="tempo-day-wrapper">
      <span
        class="tempoday-${s}"
        style="display: inline-block;"
        title="Tempo: ${s} - Date: ${n}"
        >${new Date(n).toLocaleDateString(ge(e),{weekday:t.showDayName})}</span
      >
    </span>
  `}(e,t,a.dailyweek,a.dailyweek_Tempo,i)}
      ${function(e,t,o,i,a,n){if(-1===o||0===o||"0"===o||null==o){if(!n)return Ae();{const o=n.toString().split(",")[i-1];if(o&&"-1"!==o&&parseFloat(o.replace(",","."))>0){const o=we(e.states[t.entity].attributes.daily,i,n);if(o>0)return O`
            <br /><span
            ...
            >
          `}else if(!o||"-1"===o)return Ae()}return Ee()}return O`
    <br /><span class="cons-val"
      >${ye(o)} ${t.showInTableUnit?O` ${a}`:O``}</span
    >
  `}(e,t,o,i,n,a.dailyweek_cost)}
      ${function(e,t,o){if(e.showDayPrice){const e=t.toString().split(",")[o-1];return"-1"===e?Ee():O` <br /><span class="cons-val">${ye(e,2)} €</span> `}if(e.kWhPrice)return O` <br /><span class="cons-val">${ye(t*e.kWhPrice,2)} €</span> `}(t,a.dailyweek_cost,i)}
      ${Se(t,a.dailyweek_costHC,i)}
      ${Se(t,a.dailyweek_costHP,i)}
      ${Pe(t,a.dailyweek_HC,i,n)}
      ${Pe(t,a.dailyweek_HP,i,n)}
      ${function(e,t,o,i,a,n){if(t.showDayMaxPower){const t=o.toString().split(",")[i-1],s=a.toString().split(",")[i-1];if("-1"===t)return Ee();const r=new Date(n.toString().split(",")[i-1]).toLocaleTimeString(ge(e),{hour:"2-digit",minute:"2-digit"});return"true"===s?O`
    ...
    `}}(e,t,a.dailyweek_MP,i,a.dailyweek_MP_over,a.dailyweek_MP_time)}
    </div>
  `}function Te(e,t,o){if(!0!==t.showHistory)return;const{daily:i,dailyweek:a}=o;if(void 0===a)return;let n=a.toString().split(",").length;return t.nbJoursAffichage<=n&&(n=t.nbJoursAffichage),O`
    ${ke(e,t,o)}
    <div class="week-history">
      ${function(e){if(!0===e.showTitleLign)return O`
      <div class="day">
        ${Ce(!0,"")} ${Ce(!0,"Conso")}
        ${Ce(e.showDayPrice,"Prix")} ${Ce(e.showDayPriceHCHP,"Prix HC")}
        ${Ce(e.showDayPriceHCHP,"Prix HP")} ${Ce(e.showDayHCHP,"HC")}
        ${Ce(e.showDayHCHP,"HP")} ${Ce(e.showDayMaxPower,"MP")}
        ${Ce(e.showDayMaxPowerTime,"MPtime")}
      </div>
    `}(t)}
      ${i.slice(-n).map((a,s)=>{const r=i.length-n+s+1;return He(e,t,a,r,o)}).reverse()}
    </div>
  `}function Me(e,t){if(!0===e.showError&&""!==t)return O`
        <div class="error-msg" style="color: var(--error-color, red)">
          <ha-icon id="icon" icon="mdi:alert-outline"></ha-icon>
          ${t}
        </div>
      `}const Ne=new Map([["Pas de valeur","green"],[1,"green"],[2,"yellow"],[3,"red"]]);function ze(e,t){return O`
  ...
  `}const Fe=new Map([["unknown","grey"],["Inconnu","grey"],["BLUE","blue"],["WHITE","white"],["RED","red"]]);function We(e){const t=new Date(e.attributes.date),o=e.state;return[t,Fe.get(o),o]}function Re(e,t,o){if(!e||e.length<=1||0===t)return O`<svg viewBox="0 0 100 50" class="consumption-chart"></svg>`;const i=e.map((o,i)=>`${i/(e.length-1)*100},${100-o.consumption/t*100}`).join(" ");return O`
    <svg viewBox="0 0 100 50" class="consumption-chart">
      <polyline points="${i}" fill="none" stroke="${o}" stroke-width="2" />
    </svg>
  `}function Le(e,t,o,i,a){if(!t.showDetailedComparison)return O``;if(!t.detailedComparisonEntity)return O``;const n=e.states[t.detailedComparisonEntity];if(!n)return O`
    ...
    <div class="comparison-charts">
      <div class="chart-day">
        <h4>Aujourd'hui</h4>
        <div class="mini-chart">${Re(e.today,o,"#2196f3")}</div>
        <div class="day-stats">
      ...
      <div class="chart-day">
        <h4>Hier</h4>
        <div class="mini-chart">${Re(e.yesterday,o,"#666")}</div>
        <div class="day-stats">
  ...
  `:O`
    ...
    `}const Ue="1.7.1";window.customCards=window.customCards||[],window.customCards.push({type:"content-card-linky",name:"Carte Enedis",description:"Carte pour l'intégration MyElectricalData - Affichage moderne des données Linky avec évolutions colorées",preview:!0,documentationURL:"https://github.com/MyElectricalData/content-card-linky",version:Ue}),console.info(`%c content-card-linky %c v${Ue} `,"color: white; background: #4caf50; font-weight: 700;","color: white; background: #1976d2; font-weight: 700;");customElements.define("content-card-linky",class extends ne{static get properties(){return{config:{attribute:!1},hass:{attribute:!1},_monthlyExpanded:{state:!0},_yearlyExpanded:{state:!0},_detailedExpanded:{state:!0}}}constructor(){super(),this._monthlyExpanded=!1,this._yearlyExpanded=!1,this._detailedExpanded=!1}static async getConfigElement(){return await import("./content-card-linky-editor.js"),document.createElement("content-card-linky-editor")}static async getStubConfig(e){let t="sensor.linky_consumption";if(e&&e.states){const o=Object.keys(e.states).find(t=>{if(!t.startsWith("sensor."))return!1;const o=e.states[t].attributes||{};return/linky/i.test(t)||"consommation"===o.typeCompteur||void 0!==o.daily&&void 0!==o.dailyweek});o&&(t=o)}return{type:"custom:content-card-linky",entity:t,titleName:"LINKY",nbJoursAffichage:"7",showIcon:!0,showHistory:!0,showPrice:!0,showDayPrice:!0,showCurrentMonthRatio:!0,showWeekRatio:!0,showDayName:"long",showDayMaxPower:!0,showTitleLign:!0,showEcoWatt:!0,showTempo:!1,showMonthlyView:!0,showYearlyView:!0,showDetailedComparison:!0,detailedComparisonEntity:"sensor.linky_consumption_last5day"}}render(){if(!this.config||!this.hass)return O``;const e=this.hass.states[this.config.entity];if(!e)return O`
      ...
      `;{const e=t.dailyweek_cost.toString().split(","),o=parseFloat(e[0]?.replace(",","."));if(!isNaN(o)&&o>0){const e=we(t.daily,1,t.dailyweek_cost);if(e>0)return O`
  ...
  `}(e.state,t)}</div>
          ...
          ${Me(this.config,t.errorLastCall)}
        </div>
  ...
  `}(this.config,t,this._yearlyExpanded,e=>this.toggleYearlyView(e))}
          ${Le(this.hass,this.config,t,this._detailedExpanded,e=>this.toggleDetailedComparison(e))}
