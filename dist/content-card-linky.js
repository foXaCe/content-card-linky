...
`;function ve(e,t=1){const a=Number.parseFloat(e);return isNaN(a)?"–":a.toFixed(t)}function ye(e){return e?.locale?.language||"en"}function fe(e){return e.showIcon?O` <div class="icon-block">
  ...
  </span>`}function Pe(e,t){if(null!=e)return e.toString().split(",")[t-1]}function Se(e,t,a,o=new Date){if(!t.showWeekSummary&&void 0!==t.showWeekSummary)return O``;const{daily:i,unit_of_measurement:n,dailyweek_cost:r}=a,s=be(i,r,o),l=$e(r,o),c=new Date(o);c.setDate(o.getDate()-(0===o.getDay()?6:o.getDay()-1));const p=function(e=new Date){const t=e.getMonth();return t>=2&&t<=4?{primary:"#66bb6a",accent:"#81c784",icon:"mdi:flower"}:t>=5&&t<=7?{primary:"#42a5f5",accent:"#29b6f6",icon:"mdi:white-balance-sunny"}:t>=8&&t<=10?{primary:"#ff7043",accent:"#ffab40",icon:"mdi:leaf"}:{primary:"#5c6bc0",accent:"#7986cb",icon:"mdi:snowflake"}}(o);return O`
  ...
  `}function Te(e,t,a,o,i,n=new Date){if(a&&"undefined"!==a.toString()){const e=Pe(a,o);if(e&&"-1"!==e)return e.toLowerCase()}const r=function(e,t){const a=["sensor.rte_tempo_today","sensor.edf_tempo_today","sensor.tempo_today","sensor.rte_tempo_tomorrow","sensor.edf_tempo_tomorrow","sensor.tempo_tomorrow"],o={};for(const t of a)if(e.states[t]){const a=e.states[t];a.state&&ue.has(a.state)&&(t.includes("today")?o.today=t:t.includes("tomorrow")&&(o.tomorrow=t))}if(t.tempoEntity&&e.states[t.tempoEntity]){const a=e.states[t.tempoEntity];a.state&&ue.has(a.state)&&(o.today=t.tempoEntity)}return o}(e,t);if(i&&Object.keys(r).length>0){const t=new Date(i),a=new Date(n),o=new Date(n);if(o.setDate(a.getDate()+1),t.toDateString()===a.toDateString()&&r.today){const t=e.states[r.today];if(t&&t.state&&ue.has(t.state))return ue.get(t.state)}if(t.toDateString()===o.toDateString()&&r.tomorrow){const t=e.states[r.tomorrow];if(t&&t.state&&ue.has(t.state))return ue.get(t.state)}}return"grey"}function He(e,t,a,o,i,n){if(-1===a||0===a||"0"===a||null==a){if(!n)return Me(e);{const a=Pe(n,o);if(a&&"-1"!==a&&parseFloat(String(a??"").replace(",","."))>0){const a=function(e,t,a){if(!e||!a)return 0;const o=a.toString().split(","),i=parseFloat(o[t-1]?.replace(",","."));if(isNaN(i)||i<=0)return 0;const n=[];for(let t=0;t<Math.min(e.length,o.length,7);t++){const a=parseFloat(e[t]),i=parseFloat(o[t]?.replace(",","."));!isNaN(a)&&!isNaN(i)&&a>0&&i>0&&-1!==a&&-1!==i&&n.push(a/i)}return 0===n.length?0:i*(n.reduce((e,t)=>e+t,0)/n.length)}(e.states[t.entity].attributes.daily,o,n);if(a>0)return O`
    ...
    <br /><span class="cons-val"
      >${ve(a)} ${t.showInTableUnit?O` ${i}`:O``}</span
    >
  `}function Ne(e,t,a,o){if(t.showDayPriceHCHP){const t=Pe(a,o);return"-1"===t?Ce(e):O` <br /><span class="cons-val">${ve(t,2)} €</span> `}}function We(e,t,a,o,i){if(t.showDayHCHP){const n=Pe(a,o);return"-1"===n?Ce(e):O`
      <br /><span class="cons-val"
    ...
    <div class="day">
      ${function(e,t,a,o,i,n){const r=Pe(a,i);let s="grey";return t.showTempoColor&&(s=Te(e,t,o,i,r,n)),O`
  ...
  `}(e,t,i.dailyweek,i.dailyweek_Tempo,o,n)}
      ...
      ${function(e,t,a,o,i){if(t.showDayPrice){const t=Pe(a,o);return"-1"===t?Ce(e):O` <br /><span class="cons-val">${ve(t,2)} €</span> `}if(t.kWhPrice){const a=parseFloat(i);return isNaN(a)||a<=0?Ce(e):O` <br /><span class="cons-val">${ve(a*t.kWhPrice,2)} €</span> `}}(e,t,i.dailyweek_cost,o,a)}
      ${Ne(e,t,i.dailyweek_costHC,o)}
      ${Ne(e,t,i.dailyweek_costHP,o)}
      ${We(e,t,i.dailyweek_HC,o,r)}
      ${We(e,t,i.dailyweek_HP,o,r)}
      ${function(e,t,a,o,i,n){if(t.showDayMaxPower){const r=Pe(a,o),s=Pe(i,o);if("-1"===r)return Ce(e);const l="true"===s?"color: var(--error-color, red)":"",c=!1!==t.showDayMaxPowerTime?O`<br /><span class="cons-val" style="${l}"
              >${new Date(Pe(n,o)??"").toLocaleTimeString(ye(e),{hour:"2-digit",minute:"2-digit"})}</span
