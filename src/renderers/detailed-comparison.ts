...
import { parseDetailedTimeSeries } from "../lib/calculations";
import { localize } from "../lib/localize";
import { onActivate } from "../lib/a11y";
import type { ComparisonData, ConsumptionPoint } from "../lib/calculations";
...
function parseLegacyDetailedData(
  { Daily, Dailyweek }: { Daily: string; Dailyweek: string },
  now: Date = new Date(),
): ComparisonData {
...
function renderMiniChart(data: ConsumptionPoint[], maxValue: number, color: string): TemplateResult {
...
function renderComparisonCharts(hass: HomeAssistant, data: ComparisonData, unit: any): TemplateResult {
...
function renderComparisonStats(hass: HomeAssistant, data: ComparisonData): TemplateResult {
 ...
 */
export function renderDetailedComparison(
  hass: HomeAssistant,
